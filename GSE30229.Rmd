...
```{r, include=TRUE, echo=TRUE}
#Kitaip jie dar gali buti vadinami "p-hacking". Tai statistiniu metodu naudojimas tam, kad isgauti geresnius, reiksmingesnius rezultatus. 
#Yra eksperimentu, kuriu duomenyse yra didelis kintamuju skaicius. Tokie didelio nasumo eksperimetai atliekami genetikoje ir image analysis. 

#I si testavimo buda ieina:
#1) skirtumai tarp nulines ir alternatyvios hipotezes
#2) reiksmingumo lygiai
#3) Type I and Type II errors
#4)p-values

#Atliekant multiple hypothesis testing mes tikriname individualiai kiekviena nuline hipoteze. Kad galetume atmesti bent kelias nulines hipotezes. 
```
...
normalizedMatrix_without_2ndoutliers <- normalizedMatrix_without_1stoutliers[,-c(second_outs)]
full_sickness_without_2stoutliers <- full_sickness_without_1stoutliers[-(second_outs),]
