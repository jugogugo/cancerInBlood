...
stopifnot(all(dnamEstimates$SampleID == cellCounts$X))
dnamEstimates$Bcell <- cellCounts$Bcell
dnamEstimates$CD4T <- cellCounts$CD4T
dnamEstimates$CD8T <- cellCounts$CD8T
dnamEstimates$Gran <- cellCounts$Gran
dnamEstimates$Mono <- cellCounts$Mono
dnamEstimates$NK <- cellCounts$NK
