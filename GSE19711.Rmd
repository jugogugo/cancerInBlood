...
Preparing for overlap analysis
...
observed1 <- cbind(computeFit(permute = FALSE))
head(observed1)
table(observed1)
...
```{r}
saveRDS(observed1, file = "GSE19711_fit.RDS")
saveRDS(expected1, file = "GSE19711_perm.RDS")
```
